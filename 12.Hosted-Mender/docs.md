...
- Remove stdlib error messages from unit test assertions
- *(gui)* Stabilized xterm related snapshot rendering after dep update
- Aligned 2fa code generation w/ updated dependency
- Make curve constants class instances
- *(deployments)* Unit tests for getting deployment app logic
- Removed gui compose override as the image is expected to be os only

### ⚙️ Miscellaneous Tasks

- *(gui)* Aligned snapshots after mui updates
- Bump the playwright group
- *(gui)* Tuned test expectations after dependency updates
- *(gui)* Aligned test reference versions after mender-demo-artifact update
- Bump the playwright group
- Bump the e2e-test-dependencies group
- Bump the production-dependencies group
- Bump the mui group in /frontend with 3 updates
- Install bash in create-artifact-worker
- *(gui)* Aligned reference terminal screenshot after xterm update
- Bump the mui group in /frontend with 3 updates
- *(gui)* Aligned snapshots after mui update
- Bump the development-dependencies group across 1 directory with 16 updates
- *(gui)* Fixed linter issues after dep update
- *(gui)* Aligned jest setup w/ updated msw
- Bump enterprise golang versions to 1.25.6
- Bump generate-delta-worker alpine to 3.22.2
- Upgraded node image used in frontend jobs to supported version
- Replace deprecated import
- Bump the backend-docker-dependencies group across 10 directories with 2 updates
- Update node to 24.x (LTS) for job frontend:licenses
...
- Bump the production-dependencies group
- *(gui)* Aligned 2fa code generation w/ updated dep
- Bump the development-dependencies group across 1 directory with 16 updates
- *(gui)* Aligned license location after dep update
- *(gui)* Aligned license references with updated versions
- Bump the mui group in /frontend with 3 updates
- *(gui)* Aligned snapshots after mui update
- Bump axios
- Bump axios in /frontend in the production-dependencies group
- Bump the development-dependencies group
- Bump the playwright group
- Bump the production-dependencies group
- Bump the development-dependencies group
- *(gui)* Aligned license location after dependency update
- Bump the backend-golang-dependencies group
- Bump golang-ci lint to v2.11.3
- Bump the backend-docker-compose-dependencies group across 2 directories with 2 updates
- Bump the backend-tests-python-dependencies group across 3 directories with 29 updates
- Fix staticcheck issues
- Let release branches use latest release branch image on non-main branches
- Revert Use Virtual Device for OS updates in docker composition"
- Enabled wider tracing in e2e tests
- Release 4.0.2
- Release 4.0.2
- *(4.0.x)* Release 4.0.2
- Fix release branch & tag detection for e2e tests & publishing
- Reformat python code after black update
- Added git compatible way of ignoring e.g. formatting induced mass changes
- Formatted python code after black update
- Let enterprise black update induced formatting be ignored
- Let e2e tests rely on minor versions of ent images on release-tags + -branches
- *(4.0.x)* Release 4.0.2
